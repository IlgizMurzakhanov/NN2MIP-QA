...
% % size_L_PG = size(L_PG)
% % size_U_PG = size(U_PG)
% om_userfcn_formulation_fcn = om.userfcn.formulation.fcn
% om_userfcn_formulation_args = om.userfcn.formulation.args
% 
% disp('Before om_PG add_constraints')
% 
% % om = add_constraints(om, 'Linkage_Constraints_PG', A_PG, L_PG, U_PG, {'Pg'});
% % om = add_constraints(om, 'Linkage_Constraints_PG', A_PG, L_PG, U_PG, {});
% % om = add_constraints(om, 'linkage_constraints', A_PG, L_PG, U_PG, {});
% om = add_lin_constraint(om, 'linkage_constraints', A_PG, L_PG, U_PG, {'Pg'});
% 
% 
% disp('After om_PG add_constraints')
% 
% nvg =size(v_IDs,1);
% 
...
% om_userfcn_formulation_args = om.userfcn.formulation.args
% 
% disp('Before om_VG add_constraints')
% 
% om = add_constraints(om, 'Linkage_Constraints_VG', A_VG, L_VG, U_VG, {'Vm'});
% 
% disp('After om_VG add_constraints')
% 
